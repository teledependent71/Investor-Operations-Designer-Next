...
import booksPageInitialPaths1df7dResource from '../../../resources/books-page-initial-paths-1df7d'
import booksPageInitialProps8c8a9Resource from '../../../resources/books-page-initial-props-8c8a9'
...
export async function getStaticPaths() {
  const response = await booksPageInitialPaths1df7dResource({})
...
export async function getStaticProps(context) {
  const response = await booksPageInitialProps8c8a9Resource({
    ...context?.params,
